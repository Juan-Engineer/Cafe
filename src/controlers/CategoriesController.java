    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(row == -1){
            JOptionPane.showMessageDialog(null, "Debes seleccionar una categoría");
                ...
                int question = JOptionPane.showConfirmDialog(null, "¿En realidad quieres eliminar la categoría?");
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.categories_table) {
            ...
            if(rol.equals("Administrador")){
                ...
                JOptionPane.showMessageDialog(null, "No tienes permisos de admin");
            }
        }
    }
