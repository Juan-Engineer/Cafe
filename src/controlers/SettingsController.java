...
import static models.EmployeesDao.phone_user;
...
public class SettingsController implements MouseListener{
    ...
    this.views.txt_phone_profile.setText(phone_user);
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        }else if(e.getSource() == views.jLabel){
    ...
    public void mouseExited(MouseEvent e) {
        if(e.getSource() == views.jLabelProducts){
        views.jPanelProducts.setBackground(new Color(51,51,0));
        }else if(e.getSource() == views.jLabelPurchases){
        views.jPanelPurchases.setBackground(new Color(51,51,0));
        }else if(e.getSource() == views.jLabel){
        views.jPanelSales.setBackground(new Color(152, 202, 63));
        }else if(e.getSource() == views.jLabelCustomers){
        views.jPanelCustomers.setBackground(new Color(51,51,0));
        }else if(e.getSource() == views.jLabelEmployees){
        views.jPanelEmployees.setBackground(new Color(51,51,0)); 
        }else if(e.getSource() == views.jLabelSuppliers){
        views.jPanelSuppliers.setBackground(new Color(51,51,0));
        }else if(e.getSource() == views.jLabelCategories){
        views.jPanelCategories.setBackground(new Color(51,51,0));
        }else if(e.getSource() == views.jLabelReports){
        views.jPanelReports.setBackground(new Color(51,51,0));
        }else if(e.getSource() == views.jLabelSettings){
        views.jPanelSettings.setBackground(new Color(51,51,0));
        }
    }
