...
public class SuppliersController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_supplier) {
            if (views.txt_supplier_name.getText().equals("")
                    ...
                    || views.txtx_supplier_email.getText().equals("")
                ...
                supplier.setPhone(views.txt_supplier_telephone.getText().trim());
                supplier.setEmail(views.txtx_supplier_email.getText().trim());
            ...
            if (views.txt_supplier_id.getText().equals("")) {
                ...
                if (views.txt_supplier_name.getText().equals("")
                    ...
                    if (supplierDao.updateSupplierQuery(supplier)) {
                        ...
                        JOptionPane.showMessageDialog(null, "Datos del proveedor actualizados con éxito");
                    } else {
                        JOptionPane.showMessageDialog(null, "Ha ocurrido un error con la actualización");
                    }
                }
            }
            ...
            if(row == -1){
                ...
                int question = JOptionPane.showConfirmDialog(null, "En realidad quieres eliminarlo");
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.supplier_table) {
            ...
            views.txtx_supplier_email.setText(views.supplier_table.getValueAt(row, 5).toString());
            views.cmb_supplier_city.setSelectedItem(views.supplier_table.getValueAt(row, 6).toString());
            //Deshabilitar ciertos botones
            ...
            if(role.equals("Administrador")){
                ...
                JOptionPane.showMessageDialog(null, "No tienes privilegios de Admin para acceder");
            }
        }
    }
    ...
    public void cleanFields() {
        ...
        views.txtx_supplier_email.setText("");
