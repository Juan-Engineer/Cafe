...
public class ProductsDao {
    ...
    public List listProductQuery(String value){
        ...
        String query_search_product = "SELECT por.*, ca.name AS category_name FROM products pro INNER JOIN categories ca"
    ...
    public boolean updateProductQuery(Products product){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Error al modificar datos del producto ");
            return false;
        }
    }
    ...
    public boolean deleteProductQuery(int id){
        String query = "DELET FROM products WHERE id = " + id;
        try{
            conn = cn.getConnection();
            pst = conn.prepareStatement(query);
            pst.execute();
