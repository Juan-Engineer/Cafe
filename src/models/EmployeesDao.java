...
public class EmployeesDao {
    ...
    public Employees loginQuery(String user, String password){
        ...
        try{
            ...
            if(rs.next()){
                ...
                email_user = employee.getMail();
                employee.setRole(rs.getString("role"));
                role_user = employee.getRole();
    ...
    public boolean registerEmployeeQuery(Employees employee){
        String query = "INSERT INTO employees (id, full_name, username, address, phone, email, password, role, created, " + "updated) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try{
            ...
            pst.setString(6, employee.getMail());
    ...
    public List listEmployeeQuery(String value){
        ...
        String query = "SELECT * FROM employees ORDER BY role ASC";
    ...
    public boolean updateEmployeeQuery(Employees employee){
        String query = "UPDATE employees SET full_name = ?, username = ?, address = ?, phone = ?, email = ?, role = ?, updated = ? WHERE id = ?";
        ...
        try{
            ...
            pst.setString(5, employee.getMail());
            ...
            JOptionPane.showMessageDialog(null, "Error al modificar dator del empleado " + e);
            return false;
        }
    ...
    public boolean deleteEmployeeQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "No puede eliminar empleado que tenga relación con otra tabla ");
            return false;
        }
    }
