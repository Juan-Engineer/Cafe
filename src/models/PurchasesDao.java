...
public class PurchasesDao {
    ...
    public boolean registerPurchaseDetailQuery(int purchase_id, double purchase_price, int purchase_amount, 
        ...
        String query = "INSERT INTO purchase_details (purchase_id, purchase_price, purchase amount,"
    ...
    public List listPurchaseDetailQuery(int id){
        ...
        String query = "SELECT pu.created, pude.purchase_price, pude.purchase_amount, pude.purchase_subtotal, su.name "
                + "AS supplier_name, pro.name AS product_name, em.full_name FROM purchases pu INNER JOIN purchase_details "
                + "pude ON pu.id = pude.purchase_id INNER JOIN products pro ON pude.product_id = pro.id INNER JOIN suppliers"
                + "su ON pu.supplier_id = su.id INNER JOIN employees em ON pu.employee_id = em.id WHERE pu.id = ?";
