...
public boolean updateCategoryQuery(Categories category){
    ...
    try{
        ...
        JOptionPane.showMessageDialog(null, "Error al modificar datos de la categoría ");
        return false;
    }
}
...
public boolean deleteCategoryQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "No puede eliminar categoría que tenga relación con otra tabla ");
            return false;
        }
    }
